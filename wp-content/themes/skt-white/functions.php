...
function skt_white_custom_head_codes() { 
	if ( function_exists('of_get_option') ){
		...
		if ( of_get_option('colorscheme', true) != '' ) {
			echo '.top-bar a, .contact-banner a, input.search-submit, .post-password-form input[type=submit], .icon:hover, .newsletter-form input[type="submit"]{background-color:'. esc_html( of_get_option('colorscheme', '#00a8ff') ) .';}';
		}
		if( of_get_option('colorscheme',true) != ''){
